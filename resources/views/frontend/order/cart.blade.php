    ...
    <section class="flat-spacing-11">
        <div class="container">
            ...
            <div class="tf-page-cart text-center mt_140 mb_200">
                ...
                <a href="<?= url('/') ?>/" class="tf-btn btn-sm radius-3 btn-fill btn-icon animate-hover-btn">Return to shop<i class="icon icon-arrow1-top-left"></i></a>
            </div>
            <?php } ?>
                                    ...
                                    <td class="tf-cart-item_quantity" cart-data-title="Quantity">
                                        <div class="cart-quantity">
                                            <div class="wg-quantity">
                                                <span class="btn-quantity btndecrease remove-qty" data-hash="<?=$item->product_id?>" id="<?=$item->cart_id?>">
                                                ...
                                                <span class="btn-quantity btnincrease add-qty" data-hash="<?=$item->product_id?>" id="<?=$item->cart_id?>">
                    ...
                    <div class="tf-cart-footer-inner">
                        ...
                        <div class="tf-page-cart-checkout">
                            ...
                            <div class="tf-cart-totals-discounts">
                                <h3>Subtotal</h3>
                                <span class="total-value">Rs.<?php echo number_format($net,2); ?></span>
                            </div>
                            <p class="tf-cart-tax">
                            ...
                            <div class="cart-checkout-btn">
                                <a href="<?= url('/') ?>/checkout" class="tf-btn w-100 btn-fill animate-hover-btn radius-3 justify-content-center">
                                    <span>Check out</span>
                                </a>
                            </div>
