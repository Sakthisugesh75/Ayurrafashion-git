      ...
      <div class="row">
        <div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
            <div class="card card-mini dash-card card-1">
                <div class="card-body">
                    <h2 class="mb-1"><?php echo $record['todaynewuser']; ?></h2>
                    <p>Daily Signups</p>
        ...
        <div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
            <div class="card card-mini dash-card card-2">
                <div class="card-body">
                    <h2 class="mb-1">Rs.<?php echo $record['currentmonthordervalue']; ?></h2>
                    <p>Monthly Order Value</p>
        ...
        <div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
            <div class="card card-mini dash-card card-3">
                <div class="card-body">
                    <h2 class="mb-1"><?php echo $record['todayorders']; ?></h2>
                    <p>Daily Order</p>
        ...
        <div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
            <div class="card card-mini dash-card card-4">
                <div class="card-body">
                    <h2 class="mb-1">Rs.<?php echo $record['todayordervalue']; ?></h2>
                    <p>Daily Revenue</p>
