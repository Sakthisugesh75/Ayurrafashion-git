...
function updateInvoice(){
    ...
    if($courier == 'delhivery'){
        ...
        "shipments": [
            {
                ...
                "seller_add": "",
                "cod_amount": "0",
                "return_phone": "8825555064",
                "seller_inv_date": "",
                "seller_name": "",
                "pin": "'.$pincode.'",
                "seller_inv": "",
                "state": "'.$state.'",
                "return_name": "KIRA HERITAGE",
                "order": "'.$order_id.'",
                "add": "'.$address.'",
                "payment_mode": "Prepaid",
                "quantity": "1",
                "return_add": "No.14, 2nd floor, Kamaraj Nagar, Avarampalayam road, Coimbatore.",
                "seller_cst": "",
                "seller_tin": "",
                "phone": "'.$phone.'",
        ...
        "pickup_location": {
            ...
            "country": "India",
            "phone": "8825555064",
            "add": "No.14, 2nd floor, Kamaraj Nagar, Avarampalayam road, Coimbatore.",
            "state": "Tamil nadu"
        }
    }',
          ...
          CURLOPT_HTTPHEADER => array(
            'Authorization: Token f79e66ff45cc8412c37695c84de49c6bc44a4e48',
            'Content-Type: application/json',
    ...
    $this->morder->awbUpdate( $order_id,$courier,$awb,$tracking_url);
        ...
        $this->_response_data['status']="SUCCESS";
        $this->_response_data['code']="206";
        $this->_response_data['res']=$response;
      }else{
        $this->_response_data['status']="FAILED";
        $this->_response_data['code']="209";
      }
